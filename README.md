...
Turso Database — это проект по созданию следующего поколения SQLite на Rust с акцентом на открытый вклад сообщества и такими возможностями, как нативная асинхронность, векторный поиск и другое. В отличие от libSQL (форк SQLite), Turso — это полная переработка с нуля.
